...
import static com.telekurye.maphelpers.MathUtil.*;
...
public class PolyUtil {
	...
	/**
	 * Returns tan(latitude-at-lng3) on the great circle (lat1, lng1) to (lat2, lng2). lng1==0. See http://williams.best.vwh.net/avform.htm .
	 */
	...
	/**
	 * Computes whether the given point lies inside the specified polygon. The polygon is always cosidered closed, regardless of whether the last point equals the first or not. Inside is defined as
	 * not containing the South Pole -- the South Pole is always outside. The polygon is formed of great circle segments if geodesic is true, and of rhumb (loxodromic) segments otherwise.
	 */
	...
	/**
	 * Computes whether the given point lies on or near the edge of a polygon, within a specified tolerance in meters. The polygon edge is composed of great circle segments if geodesic is true, and of
	 * Rhumb segments otherwise. The polygon edge is implicitly closed -- the closing segment between the first point and the last point is included.
	 */
	...
	/**
	 * Computes whether the given point lies on or near a polyline, within a specified tolerance in meters. The polyline is composed of great circle segments if geodesic is true, and of Rhumb segments
	 * otherwise. The polyline is not closed -- the closing segment between the first point and the last point is not included.
	 */
	...
	/**
	 * Returns sin(initial bearing from (lat1,lng1) to (lat3,lng3) minus initial bearing from (lat1, lng1) to (lat2,lng2)).
	 */
