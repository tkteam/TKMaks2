...
public class HttpRequestForJson {
	...
	public HttpRequestForJson() {
		// TODO Auto-generated constructor stub
	}

	public String getJsonData(String districtid) {
		String str = "";

		String url = "http://maks2.terralabs.com.tr/MaksAndroidControlMissionsByLocationId.aspx?username=" //
				+ Info.USERNAME + "&password=" + Info.PASSWORD + "&function=GET&districtId=" + districtid;
