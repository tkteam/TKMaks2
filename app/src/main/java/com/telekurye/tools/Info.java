...
public class Info {
	...
	public static String		DISTRICT_ID				= "28000";
	// public static String DATA_URL =
	// "http://192.168.11.8/MAKS.Web/MaksAndroidControlMissionsByLocationId.aspx";
	public static final String	DATA_URL				= "http://maks2.terralabs.com.tr/MaksAndroidControlMissionsByLocationId.aspx";
	public static String		asdf					= "http://maks2.terralabs.com.tr/MaksAndroidControlMissionsByLocationId.aspx?username=si&password=si123..&districtId=28000&function=GET";
	...
	public static String		LOGIN_SERVICE_URL		= "http://95.0.160.181/Default.aspx";
	public static String		PHOTO_SYNC_URL			= "http://95.0.160.181/PhotoSync.aspx";
	public static String		ERROR_LOG_URL			= "http://95.0.160.181/ExceptionLog.aspx";
	public static String		VEHICLE_PHOTO_SYNC_URL	= "http://95.0.160.181/PhotoSyncVehicle.aspx";
	...
	// "http://maksandroid.terralabs.com.tr/Default.aspx";
	// public static String PHOTO_SYNC_URL =
	// "http://maksandroid.terralabs.com.tr/PhotoSync.aspx";
	// public static String ERROR_LOG_URL =
	// "http://maksandroid.terralabs.com.tr/ExceptionLog.aspx";
	// public static String VEHICLE_PHOTO_SYNC_URL =
	// "http://maksandroid.terralabs.com.tr/PhotoSyncVehicle.aspx";

	// ###########################################################################

	// wifiye geç
	// public static String LOGIN_SERVICE_URL =
	// "http://192.168.11.10/MAKS.Android.Web/Default.aspx";
	// public static String PHOTO_SYNC_URL =
	// "http://192.168.11.10/MAKS.Android.Web/PhotoSync.aspx";
	// public static String ERROR_LOG_URL =
	// "http://192.168.11.10/MAKS.Android.Web/ExceptionLog.aspx";
	// public static String VEHICLE_PHOTO_SYNC_URL =
	// "http://192.168.11.10/MAKS.Android.Web/PhotoSyncVehicle.aspx";
	...
	public static Boolean		isClearAllCodeActive	= false;
