...
public class EnhancedPrecisionOp
{
  ...
  /**
   * Computes the set-theoretic symmetric difference of two {@link com.vividsolutions.jts.geom.Geometry}s, using enhanced precision.
   * @param geom0 the first Geometry
   * @param geom1 the second Geometry
  ...
  /**
   * Computes the buffer of a {@link com.vividsolutions.jts.geom.Geometry}, using enhanced precision.
