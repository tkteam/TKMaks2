...
public class CommonBitsOp {
  ...
  /**
   * Creates a new instance of class, which reshifts result {@link com.vividsolutions.jts.geom.Geometry}s.
   */
  public CommonBitsOp()
  {
    this(true);
   ...
   * the result {@link com.vividsolutions.jts.geom.Geometry}s should be reshifted.
   *
  ...
  /**
   * Computes the set-theoretic intersection of two {@link com.vividsolutions.jts.geom.Geometry}s, using enhanced precision.
  ...
  /**
   * Computes the set-theoretic union of two {@link com.vividsolutions.jts.geom.Geometry}s, using enhanced precision.
   * @param geom0 the first Geometry
   * @param geom1 the second Geometry
  ...
  /**
   * Computes the set-theoretic difference of two {@link com.vividsolutions.jts.geom.Geometry}s, using enhanced precision.
   * @param geom0 the first Geometry
  ...
  /**
   * Computes a copy of the input {@link com.vividsolutions.jts.geom.Geometry} with the calculated common bits
  ...
  /**
   * Computes a copy of each input {@link com.vividsolutions.jts.geom.Geometry}s with the calculated common bits
   * removed from each coordinate.
