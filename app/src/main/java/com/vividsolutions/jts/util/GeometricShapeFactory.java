...
public class GeometricShapeFactory
{
  ...
  /**
   * Sets the total number of points in the created {@link com.vividsolutions.jts.geom.Geometry}.
  ...
  /**
   * Creates a rectangular {@link com.vividsolutions.jts.geom.Polygon}.
   *
  ...
  /**
   * Creates a circular {@link com.vividsolutions.jts.geom.Polygon}.
   *
   * @return a circle
   */
