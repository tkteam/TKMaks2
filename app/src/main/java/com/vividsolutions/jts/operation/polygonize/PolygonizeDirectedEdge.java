...
/**
 * A {@link DirectedEdge} of a {@link com.vividsolutions.jts.operation.polygonize.PolygonizeGraph}, which represents
    ...
    extends DirectedEdge
{
   ...
   * @see #setRing(com.vividsolutions.jts.operation.polygonize.EdgeRing)
   */
