...
/**
 * Tests whether any of a set of {@link com.vividsolutions.jts.geom.LinearRing}s are
 * nested inside another ring in the set, using a {@link com.vividsolutions.jts.index.sweepline.SweepLineIndex}
