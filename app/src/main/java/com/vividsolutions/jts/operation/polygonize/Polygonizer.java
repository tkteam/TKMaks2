...
public class Polygonizer
{
  ...
  /**
   * Create a polygonizer with the same {@link com.vividsolutions.jts.geom.GeometryFactory}
   * as the input {@link com.vividsolutions.jts.geom.Geometry}s
   */
  public Polygonizer()
  {
  }
   ...
   *
   * @param geomList a list of {@link com.vividsolutions.jts.geom.Geometry}s with linework to be polygonized
   */
   ...
   * the constituent linework will be extracted and used
   *
   * @param g a {@link com.vividsolutions.jts.geom.Geometry} with linework to be polygonized
   */
   ...
   *
   * @param line the {@link com.vividsolutions.jts.geom.LineString} to add
   */
   ...
   * @return a collection of {@link com.vividsolutions.jts.geom.Polygon}s
   */
   ...
   * @return a collection of the input {@link com.vividsolutions.jts.geom.LineString}s which are dangles
   */
   ...
   * @return a collection of the input {@link com.vividsolutions.jts.geom.LineString}s which are cut edges
   */
   ...
   * @return a collection of the input {@link com.vividsolutions.jts.geom.LineString}s which form invalid rings
   */
