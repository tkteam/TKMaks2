...
/**
 * Implements the SFS <tt>relate()</tt> operation on two {@link com.vividsolutions.jts.geom.Geometry}s.
 * This class supports specifying a custom {@link com.vividsolutions.jts.algorithm.BoundaryNodeRule}
 ...
 * as {@link com.vividsolutions.jts.geom.Geometry#getBoundary}.  The results of
...
{
  /**
   * Computes the {@link com.vividsolutions.jts.geom.IntersectionMatrix} for the spatial relationship
   * between two {@link com.vividsolutions.jts.geom.Geometry}s, using the default (OGC SFS) Boundary Node Rule
   *
  ...
  /**
   * Computes the {@link com.vividsolutions.jts.geom.IntersectionMatrix} for the spatial relationship
   * between two {@link com.vividsolutions.jts.geom.Geometry}s using a specified Boundary Node Rule.
   *
   * @param a a Geometry to test
   * @param b a Geometry to test
