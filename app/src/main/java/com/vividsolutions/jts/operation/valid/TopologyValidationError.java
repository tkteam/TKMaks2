...
/**
 * Contains information about the nature and location of a {@link com.vividsolutions.jts.geom.Geometry}
 * validation error
 *
 * @version 1.7
 */
public class TopologyValidationError {
  ...
  /**
   * Returns the location of this error (on the {@link com.vividsolutions.jts.geom.Geometry} containing the error).
   *
   * @return a {@link com.vividsolutions.jts.geom.Coordinate} on the input geometry
   */
