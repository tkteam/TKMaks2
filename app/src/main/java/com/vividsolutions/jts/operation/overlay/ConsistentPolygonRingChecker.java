...
/**
 * Tests whether the polygon rings in a {@link com.vividsolutions.jts.geomgraph.GeometryGraph}
 * are consistent.
...
public class ConsistentPolygonRingChecker
{
   ...
   *
   * @throws com.vividsolutions.jts.geom.TopologyException if inconsistent topology is found
   */
