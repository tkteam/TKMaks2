 ...
 * using other {@link com.vividsolutions.jts.algorithm.BoundaryNodeRule}s as well.
 * <p>
 ...
 * use {@link com.vividsolutions.jts.geom.Geometry#isValid}).
 ...
 * </ul>
 *
 * @see com.vividsolutions.jts.algorithm.BoundaryNodeRule
 *
 * @version 1.7
 */
public class IsSimpleOp
{
  ...
  /**
   * Creates a simplicity checker using a given {@link com.vividsolutions.jts.algorithm.BoundaryNodeRule}
   *
   * @param geom the geometry to test
  ...
  /**
   * Reports whether a {@link com.vividsolutions.jts.geom.LineString} is simple.
   *
  ...
  /**
   * Reports whether a {@link com.vividsolutions.jts.geom.MultiLineString} geometry is simple.
   *
   * @param geom the lineal geometry to test
   * @return true if the geometry is simple
   * @deprecated use isSimple()
