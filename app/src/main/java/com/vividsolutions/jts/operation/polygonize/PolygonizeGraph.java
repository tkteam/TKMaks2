    ...
    extends PlanarGraph
{
  ...
  /**
   * Add a {@link com.vividsolutions.jts.geom.LineString} forming an edge of the polygon graph.
   ...
   * @return a list of the {@link com.vividsolutions.jts.operation.polygonize.EdgeRing}s found by the polygonization process.
   */
   ...
   * @return a list of the {@link com.vividsolutions.jts.geom.LineString}s forming the removed cut edges
   */
