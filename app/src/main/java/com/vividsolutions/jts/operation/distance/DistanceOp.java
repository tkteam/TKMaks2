...
/**
 * Find two points on two {@link com.vividsolutions.jts.geom.Geometry}s which lie
...
public class DistanceOp
{
   ...
   * @param g0 a {@link com.vividsolutions.jts.geom.Geometry}
   * @param g1 another {@link com.vividsolutions.jts.geom.Geometry}
   ...
   * The points are presented in the same order as the input Geometries.
   *
   * @return a pair of {@link com.vividsolutions.jts.geom.Coordinate}s of the closest points
   */
