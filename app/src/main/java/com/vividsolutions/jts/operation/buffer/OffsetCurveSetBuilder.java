...
/**
 * Creates all the raw offset curves for a buffer of a {@link com.vividsolutions.jts.geom.Geometry}.
...
public class OffsetCurveSetBuilder {
   ...
   * Each offset curve has an attached {@link com.vividsolutions.jts.geomgraph.Label} indicating
  ...
  /**
   * Creates a {@link com.vividsolutions.jts.noding.SegmentString} for a coordinate list which is a raw offset curve,
