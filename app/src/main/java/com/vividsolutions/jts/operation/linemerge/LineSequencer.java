...
{
  /**
   * Tests whether a {@link com.vividsolutions.jts.geom.Geometry} is sequenced correctly.
   * {@link com.vividsolutions.jts.geom.LineString}s are trivially sequenced.
   * {@link com.vividsolutions.jts.geom.MultiLineString}s are checked for correct sequencing.
  ...
  /**
   * Adds a {@link java.util.Collection} of {@link com.vividsolutions.jts.geom.Geometry}s to be sequenced.
  ...
  /**
   * Adds a {@link com.vividsolutions.jts.geom.Geometry} to be sequenced.
   * May be called multiple times.
   * Any dimension of Geometry may be added; the constituent linework will be
   * extracted.
   *
  ...
  /**
   * Returns the {@link com.vividsolutions.jts.geom.LineString} or {@link com.vividsolutions.jts.geom.MultiLineString}
  ...
  /**
   * Builds a geometry ({@link com.vividsolutions.jts.geom.LineString} or {@link com.vividsolutions.jts.geom.MultiLineString} )
