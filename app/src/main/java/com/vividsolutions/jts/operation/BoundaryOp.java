...
/**
 * Computes the boundary of a {@link com.vividsolutions.jts.geom.Geometry}.
 * Allows specifying the {@link com.vividsolutions.jts.algorithm.BoundaryNodeRule} to be used.
 * This operation will always return a {@link com.vividsolutions.jts.geom.Geometry} of the appropriate
 * dimension for the boundary (even if the input geometry is empty).
 * The boundary of zero-dimensional geometries (Points) is
 * always the empty {@link com.vividsolutions.jts.geom.GeometryCollection}.
 *
 * @author Martin Davis
 * @version 1.7
 */
