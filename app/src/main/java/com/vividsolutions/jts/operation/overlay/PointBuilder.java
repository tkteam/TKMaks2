...
/**
 * Constructs {@link com.vividsolutions.jts.geom.Point}s from the nodes of an overlay graph.
 * @version 1.7
 */
public class PointBuilder {
  ...
  /**
   * Determines nodes which are in the result, and creates {@link com.vividsolutions.jts.geom.Point}s for them.
   *
