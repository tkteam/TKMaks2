 ...
 * single {@link com.vividsolutions.jts.geom.Geometry} component (ring, line or point).
...
// <FIX> MD - add in centre point of corner, to make sure offset closer lines have correct topology
   ...
   * @param side the side of the segment ({@link com.vividsolutions.jts.geomgraph.Position}) the offset lies on
