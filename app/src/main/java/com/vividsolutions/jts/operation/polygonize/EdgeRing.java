...
//      testPt = ptNotInList(testRing.getCoordinates(), tryRing.getCoordinates());
   ...
   * @param testPts the {@link com.vividsolutions.jts.geom.Coordinate}s to test
   * @param pts an array of {@link com.vividsolutions.jts.geom.Coordinate}s to test the input points against
   * @return a {@link com.vividsolutions.jts.geom.Coordinate} from <code>testPts</code> which is not in <code>pts</code>,
   ...
   *
   * @param pt a {@link com.vividsolutions.jts.geom.Coordinate} for the test point
   * @param pts an array of {@link com.vividsolutions.jts.geom.Coordinate}s to test
   ...
   * @param hole the {@link com.vividsolutions.jts.geom.LinearRing} forming the hole.
   */
  ...
  /**
   * Computes the {@link com.vividsolutions.jts.geom.Polygon} formed by this ring and any contained holes.
   *
   * @return the {@link com.vividsolutions.jts.geom.Polygon} formed by this ring and its holes.
   */
  ...
  /**
   * Tests if the {@link com.vividsolutions.jts.geom.LinearRing} ring formed by this edge ring is topologically valid.
   * @return
   */
   ...
   *
   * @return an array of the {@link com.vividsolutions.jts.geom.Coordinate}s in this ring
   */
  ...
  /**
   * Gets the coordinates for this ring as a {@link com.vividsolutions.jts.geom.LineString}.
   * Used to return the coordinates in this ring
   * as a valid geometry, when it has been detected that the ring is topologically
   * invalid.
   * @return a {@link com.vividsolutions.jts.geom.LineString} containing the coordinates in this ring
   */
  ...
  /**
   * Returns this ring as a {@link com.vividsolutions.jts.geom.LinearRing}, or null if an Exception occurs while
