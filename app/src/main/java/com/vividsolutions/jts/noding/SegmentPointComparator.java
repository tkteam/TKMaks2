...
public class SegmentPointComparator {
  ...
  /**
   * Compares two {@link com.vividsolutions.jts.geom.Coordinate}s for their relative position along a segment
   * lying in the specified {@link com.vividsolutions.jts.noding.Octant}.
   *
