...
/**
 * Base class for {@link com.vividsolutions.jts.noding.Noder}s which make a single
    ...
    implements Noder
{
  ...
  /**
   * Computes the noding for a collection of {@link com.vividsolutions.jts.noding.SegmentString}s.
   * Some Noders may add all these nodes to the input SegmentStrings;
   * others may only add some or none at all.
   *
   * @param segStrings a collection of {@link com.vividsolutions.jts.noding.SegmentString}s to node
   */
  public abstract void computeNodes(Collection segStrings);

  /**
   * Returns a {@link java.util.Collection} of fully noded {@link SegmentStrings}.
