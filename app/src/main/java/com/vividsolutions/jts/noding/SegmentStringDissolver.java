...
/**
 * Dissolves a noded collection of {@link com.vividsolutions.jts.noding.SegmentString}s to produce
 ...
 *
 * @version 1.7
 * @see com.vividsolutions.jts.noding.SegmentStringDissolver.SegmentStringMerger
 */
public class SegmentStringDissolver
{
  ...
  /**
   * Dissolve all {@link com.vividsolutions.jts.noding.SegmentString}s in the input {@link java.util.Collection}
   * @param segStrings
   */
  ...
  /**
   * Dissolve the given {@link com.vividsolutions.jts.noding.SegmentString}.
   *
...
*/
  ...
  /**
   * Gets the collection of dissolved (i.e. unique) {@link com.vividsolutions.jts.noding.SegmentString}s
   *
   * @return the unique {@link com.vividsolutions.jts.noding.SegmentString}s
   */
