 ...
 * on {@link com.vividsolutions.jts.index.chain.MonotoneChain}s and a {@link com.vividsolutions.jts.index.SpatialIndex}.
 * The {@link com.vividsolutions.jts.index.SpatialIndex} used should be something that supports
 * envelope (range) queries efficiently (such as a {@link Quadtree}
 * or {@link com.vividsolutions.jts.index.strtree.STRtree}.
 *
 * @version 1.7
 */
