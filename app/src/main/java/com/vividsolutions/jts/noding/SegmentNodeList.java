...
/**
 * A list of the {@link com.vividsolutions.jts.noding.SegmentNode}s present along a noded {@link com.vividsolutions.jts.noding.SegmentString}.
 *
 * @version 1.7
 */
...
//        Debug.println("Found equal nodes with different coordinates");
   ...
   * for a set of {@link com.vividsolutions.jts.noding.SegmentString}s).
   */
