 ...
 * using {@link com.vividsolutions.jts.linearref.LinearLocation}s as the index.
 */
public class LocationIndexedLine
{
   ...
   * a given linear {@link com.vividsolutions.jts.geom.Geometry}.
   *
  ...
  /**
   * Computes the {@link com.vividsolutions.jts.geom.Coordinate} for the point
  ...
  /**
   * Computes the {@link com.vividsolutions.jts.geom.LineString} for the interval
