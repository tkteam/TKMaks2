...
/**
 * Represents a location along a {@link com.vividsolutions.jts.geom.LineString} or {@link com.vividsolutions.jts.geom.MultiLineString}.
...
{
   /**
    * Gets a location which refers to the end of a linear {@link com.vividsolutions.jts.geom.Geometry}.
  ...
  /**
   * Computes the {@link com.vividsolutions.jts.geom.Coordinate} of a point a given fraction
  ...
  /**
   * Ensures the indexes are valid for a given linear {@link com.vividsolutions.jts.geom.Geometry}.
   *
   ...
   * the nearest vertex on the given linear {@link com.vividsolutions.jts.geom.Geometry},
  ...
  /**
   * Gets the {@link com.vividsolutions.jts.geom.Coordinate} along the
   * given linear {@link com.vividsolutions.jts.geom.Geometry} which is
   ...
   * location on the given linear {@link com.vividsolutions.jts.geom.Geometry}.
   *
   * @param linearGeom a linear geometry
