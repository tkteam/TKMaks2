...
/**
 * Extracts the subline of a linear {@link com.vividsolutions.jts.geom.Geometry} between
 * two {@link com.vividsolutions.jts.linearref.LinearLocation}s on the line.
 */
class ExtractLineByLocation
{
  /**
   * Computes the subline of a {@link com.vividsolutions.jts.geom.LineString} between
