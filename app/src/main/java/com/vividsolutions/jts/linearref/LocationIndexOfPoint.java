...
/**
 * Computes the {@link com.vividsolutions.jts.linearref.LinearLocation} of the point
 * on a linear {@link com.vividsolutions.jts.geom.Geometry} nearest a given {@link com.vividsolutions.jts.geom.Coordinate}.
...
class LocationIndexOfPoint
{
  ...
  /**
   * Find the nearest location along a linear {@link com.vividsolutions.jts.geom.Geometry} to a given point.
   *
  ...
  /**
   * Find the nearest {@link com.vividsolutions.jts.linearref.LinearLocation} along the linear {@link com.vividsolutions.jts.geom.Geometry}
   * to a given {@link com.vividsolutions.jts.geom.Coordinate}
   * after the specified minimum {@link com.vividsolutions.jts.linearref.LinearLocation}.
