 ...
 * ({@link com.vividsolutions.jts.geom.LineString}s and {@link com.vividsolutions.jts.geom.MultiLineString}s.
 *
 * The standard usage pattern for a {@link com.vividsolutions.jts.linearref.LinearIterator} is:
 *
 * <pre>
...
public class LinearIterator
{
  ...
  /**
   * Creates an iterator initialized to the start of a linear {@link com.vividsolutions.jts.geom.Geometry}
   *
   ...
   * a {@link LinearLocation} on a linear {@link com.vividsolutions.jts.geom.Geometry}
   *
   * @param linear the linear geometry to iterate over
  ...
  /**
   * Creates an iterator starting at
   * a component and vertex in a linear {@link com.vividsolutions.jts.geom.Geometry}
   *
   * @param linear the linear geometry to iterate over
  ...
  /**
   * Gets the {@link com.vividsolutions.jts.geom.LineString} component the iterator is current at.
   * @return a linestring
   */
  public LineString getLine()  {    return currentLine;  }

  /**
   * Gets the first {@link com.vividsolutions.jts.geom.Coordinate} of the current segment.
   * (the coordinate of the current vertex).
   * @return a {@link com.vividsolutions.jts.geom.Coordinate}
   */
  public Coordinate getSegmentStart() { return currentLine.getCoordinateN(vertexIndex); }

  /**
   * Gets the second {@link com.vividsolutions.jts.geom.Coordinate} of the current segment.
   * (the coordinate of the next vertex).
   * If the iterator is at the end of a line, <code>null</code> is returned.
   *
   * @return a {@link com.vividsolutions.jts.geom.Coordinate} or <code>null</code>
   */
