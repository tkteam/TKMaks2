...
/**
 * Computes the {@link com.vividsolutions.jts.linearref.LinearLocation} for a given length
 * along a linear {@link com.vividsolutions.jts.geom.Geometry}.
...
public class LengthLocationMap
{
  ...
  /**
   * Computes the {@link com.vividsolutions.jts.linearref.LinearLocation} for a
   * given length along a linear {@link com.vividsolutions.jts.geom.Geometry}.
   *
   * @param line the linear geometry to use
   * @param length the length index of the location
   * @return the {@link com.vividsolutions.jts.linearref.LinearLocation} for the length
   */
  ...
  /**
   * Computes the length for a given {@link com.vividsolutions.jts.linearref.LinearLocation}
   * on a linear {@link com.vividsolutions.jts.geom.Geometry}.
   *
   * @param line the linear geometry to use
   * @param loc the {@link com.vividsolutions.jts.linearref.LinearLocation} index of the location
   * @return the length for the {@link com.vividsolutions.jts.linearref.LinearLocation}
   */
  ...
  /**
   * Compute the {@link com.vividsolutions.jts.linearref.LinearLocation} corresponding to a length.
   * Negative lengths are measured in reverse from end of the linear geometry.
   * Out-of-range values are clamped.
   *
