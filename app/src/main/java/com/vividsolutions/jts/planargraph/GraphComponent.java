...
{
  /**
   * Sets the Visited state for all {@link com.vividsolutions.jts.planargraph.GraphComponent}s in an {@link java.util.Iterator}
   *
  ...
  /**
   * Sets the Marked state for all {@link com.vividsolutions.jts.planargraph.GraphComponent}s in an {@link java.util.Iterator}
   *
   * @param i the Iterator to scan
  ...
  /**
   * Finds the first {@link com.vividsolutions.jts.planargraph.GraphComponent} in a {@link java.util.Iterator} set
