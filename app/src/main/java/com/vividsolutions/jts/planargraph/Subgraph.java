 ...
 * A subgraph may contain any subset of {@link com.vividsolutions.jts.planargraph.Edge}s
 * from the parent graph.
 * It will also automatically contain all {@link DirectedEdge}s
 * and {@link com.vividsolutions.jts.planargraph.Node}s associated with those edges.
...
public class Subgraph
{
  ...
  /**
   * Adds an {@link com.vividsolutions.jts.planargraph.Edge} to the subgraph.
   * The associated {@link DirectedEdge}s and {@link com.vividsolutions.jts.planargraph.Node}s
   * are also added.
   *
  ...
  /**
   * Returns an {@link java.util.Iterator} over the {@link DirectedEdge}s in this graph,
  ...
  /**
   * Returns an {@link java.util.Iterator} over the {@link com.vividsolutions.jts.planargraph.Edge}s in this graph,
   * in the order in which they were added.
   *
  ...
  /**
   * Returns an {@link java.util.Iterator} over the {@link com.vividsolutions.jts.planargraph.Node}s in this graph.
   * @return an iterator over the nodes
   */
  public Iterator nodeIterator()  {    return nodeMap.iterator();  }

  /**
   * Tests whether an {@link com.vividsolutions.jts.planargraph.Edge} is contained in this subgraph
