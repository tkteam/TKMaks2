 ...
 * {@link com.vividsolutions.jts.planargraph.Edge}s and {@link com.vividsolutions.jts.planargraph.Node}s) which can be added to the graph. An
...
public abstract class PlanarGraph
{
  ...
  /**
   * Returns the {@link com.vividsolutions.jts.planargraph.Node} at the given location,
   * or null if no {@link com.vividsolutions.jts.planargraph.Node} was there.
   *
  ...
  /**
   * Tests whether this graph contains the given {@link com.vividsolutions.jts.planargraph.Edge}
   *
   ...
   * were added.
   *
   * @see #add(com.vividsolutions.jts.planargraph.Edge)
  ...
  /**
   * Removes an {@link com.vividsolutions.jts.planargraph.Edge} and its associated {@link DirectedEdge}s
   * from their from-Nodes and from the graph.
   * Note: This method does not remove the {@link com.vividsolutions.jts.planargraph.Node}s associated
   * with the {@link com.vividsolutions.jts.planargraph.Edge}, even if the removal of the {@link com.vividsolutions.jts.planargraph.Edge}
   * reduces the degree of a {@link com.vividsolutions.jts.planargraph.Node} to zero.
   */
