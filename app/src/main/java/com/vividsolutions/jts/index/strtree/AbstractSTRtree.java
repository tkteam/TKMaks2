 ...
 *
 * @see com.vividsolutions.jts.index.strtree.STRtree
 * @see com.vividsolutions.jts.index.strtree.SIRtree
 *
 * @version 1.7
 */
public abstract class AbstractSTRtree {
   ...
   * of AbstractSTRtree have different implementations of bounds.
   * @see com.vividsolutions.jts.index.strtree.AbstractSTRtree.IntersectsOp
   */
