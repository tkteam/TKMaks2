 ...
 *  can be applied to the coordinates in a {@link com.vividsolutions.jts.geom.CoordinateSequence}.
 ...
 *  {@link com.vividsolutions.jts.geom.Geometry} classes support the concept of applying a
 *  <code>CoordinateSequenceFilter</code> to each
 *  {@link com.vividsolutions.jts.geom.CoordinateSequence}s they contain.
 *  <p>
...
{
  /**
   * Performs an operation on a coordinate in a {@link com.vividsolutions.jts.geom.CoordinateSequence}.
   *
   ...
   * If so, {@link com.vividsolutions.jts.geom.Geometry#geometryChanged} will be executed.
   * <p>
