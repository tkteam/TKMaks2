	...
	implements Cloneable, CoordinateSequenceFilter
{
  ...
  */
  ...
  /**
   * Composes the given {@link com.vividsolutions.jts.geom.util.AffineTransformation}
   ...
   * with the given {@link com.vividsolutions.jts.geom.util.AffineTransformation}.
   * This produces a transformation whose effect
