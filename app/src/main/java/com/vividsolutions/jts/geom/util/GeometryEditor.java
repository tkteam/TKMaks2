...
public class GeometryEditor
{
   ...
   * Clients will create subclasses of {@link com.vividsolutions.jts.geom.util.GeometryEditor.GeometryEditorOperation} or
   * {@link com.vividsolutions.jts.geom.util.GeometryEditor.CoordinateOperation} to perform required modifications.
   *
  ...
  /**
   * A {@link com.vividsolutions.jts.geom.util.GeometryEditor.GeometryEditorOperation} which modifies the coordinate list of a {@link Geometry}.
