...
/**
 * Compares two {@link com.vividsolutions.jts.geom.CoordinateSequence}s.
	...
	implements Comparator
{
  ...
  /**
   * Compares two {@link com.vividsolutions.jts.geom.CoordinateSequence}s for relative order.
   *
   * @param o1 a {@link com.vividsolutions.jts.geom.CoordinateSequence}
   * @param o2 a {@link com.vividsolutions.jts.geom.CoordinateSequence}
  ...
  /**
   * Compares the same coordinate of two {@link com.vividsolutions.jts.geom.CoordinateSequence}s
   * along the given number of dimensions.
   *
   * @param s1 a {@link com.vividsolutions.jts.geom.CoordinateSequence}
   * @param s2 a {@link com.vividsolutions.jts.geom.CoordinateSequence}
