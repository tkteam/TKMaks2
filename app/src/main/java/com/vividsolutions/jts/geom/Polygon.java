...
/**
 * Represents a linear polygon, which may include holes. The shell and holes of the polygon are represented by {@link LinearRing}s. In a valid polygon, holes may touch the shell or other holes at a
 * single point. However, no sequence of touching holes may split the polygon into two pieces. The orientation of the rings in the polygon does not matter.
 * <p>
 * The shell and holes must conform to the assertions specified in the <A HREF="http://www.opengis.org/techno/specs.htm">OpenGIS Simple Features Specification for SQL</A> .
 *
 * @version 1.7
 */
public class Polygon extends Geometry {
	 ...
	 *            the outer boundary of the new <code>Polygon</code>, or <code>null</code> or an empty <code>LinearRing</code> if the empty geometry is to be created.
	 * @param holes
	 *            the inner boundaries of the new <code>Polygon</code> , or <code>null</code> or empty <code>LinearRing</code>s if the empty geometry is to be created.
	 * @param precisionModel
	 *            the specification of the grid of allowable points for this <code>Polygon</code>
	 * @param SRID
	 *            the ID of the Spatial Reference System used by this <code>Polygon</code>
	...
	/**
	 * Creates and returns a full copy of this {@link com.vividsolutions.jts.geom.Polygon} object. (including all coordinates contained by it).
	 *
