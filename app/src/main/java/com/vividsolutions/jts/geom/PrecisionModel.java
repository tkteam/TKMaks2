...
/**
 * Specifies the precision model of the {@link com.vividsolutions.jts.geom.Coordinate}s in a {@link com.vividsolutions.jts.geom.Geometry}.
...
{
	/**
	 * Determines which of two {@link com.vividsolutions.jts.geom.PrecisionModel}s is the most precise
...
//  		return Math.rint(val * scale) / scale;
  ...
  /**
   *  Compares this {@link com.vividsolutions.jts.geom.PrecisionModel} object with the specified object for order.
