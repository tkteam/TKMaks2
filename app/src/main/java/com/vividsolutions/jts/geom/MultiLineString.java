...
public class MultiLineString extends GeometryCollection {
  ...
  /**
   * Creates a {@link com.vividsolutions.jts.geom.MultiLineString} in the reverse
   * order to this object.
   * Both the order of the component LineStrings
   * and the order of their coordinate sequences
   * are reversed.
   *
   * @return a {@link com.vividsolutions.jts.geom.MultiLineString} in the reverse order
   */
