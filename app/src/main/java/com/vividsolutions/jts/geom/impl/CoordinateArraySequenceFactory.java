    ...
    implements CoordinateSequenceFactory, Serializable
{
  ...
  /**
   * Returns the singleton instance of {@link com.vividsolutions.jts.geom.impl.CoordinateArraySequenceFactory}
   */
  ...
  /**
   * Returns a {@link com.vividsolutions.jts.geom.impl.CoordinateArraySequence} based on the given array (the array is
   * not copied).
   *
   * @param coordinates
