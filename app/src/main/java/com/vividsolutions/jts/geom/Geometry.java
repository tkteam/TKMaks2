    ...
    implements Cloneable, Comparable, Serializable
{
   ...
   *  interface.
   *
   *@return    the name of this <code>Geometry</code>s most specific <code>com.com.vividsolutions.jts.geom</code>
   *      interface
   */
  ...
  /**
   * Returns the number of {@link com.vividsolutions.jts.geom.Geometry}s in a {@link GeometryCollection}
  ...
  /**
   * Returns an element {@link com.vividsolutions.jts.geom.Geometry} from a {@link GeometryCollection}
  ...
  /**
   * Tests whether this {@link com.vividsolutions.jts.geom.Geometry} is simple.
   ...
   *    boundary points.
   *  </UL>
   * Simplicity is defined for each {@link com.vividsolutions.jts.geom.Geometry} subclass as follows:
   * <ul>
   ...
   *
   * @return a {@link com.vividsolutions.jts.geom.Point} which is the centroid of this Geometry
   */
   ...
   *
   * @return a {@link com.vividsolutions.jts.geom.Point} which is in the interior of this Geometry
   */
   ...
   * and/or update any information it has cached (such as its {@link com.vividsolutions.jts.geom.Envelope} ).
   */
   ...
   *      disjoint
   *
   * @see com.vividsolutions.jts.geom.Geometry#intersects
   */
   ...
   *
   * @see com.vividsolutions.jts.geom.Geometry#disjoint
   */
   ...
   *      <code>other</code>
   *
   * @see com.vividsolutions.jts.geom.Geometry#contains
   */
   ...
   *
   * @see com.vividsolutions.jts.geom.Geometry#within
   */
   ...
   *
   * @see com.vividsolutions.jts.geom.Geometry#contains
   * @see com.vividsolutions.jts.geom.Geometry#coveredBy
   */
   ...
   *
   * @see com.vividsolutions.jts.geom.Geometry#within
   * @see com.vividsolutions.jts.geom.Geometry#covers
   */
  ...
  /**
   * Creates and returns a full copy of this {@link com.vividsolutions.jts.geom.Geometry} object
  ...
  protected void checkNotGeometryCollection(Geometry g) {
    ...
    if (g.getClass().getName().equals("com.com.vividsolutions.jts.geom.GeometryCollection")) {
