...
/**
 * Builds an {@link com.vividsolutions.jts.geom.util.AffineTransformation} defined by three control points
...
public class AffineTransformationBuilder
{
  ...
  /**
   * Computes the {@link com.vividsolutions.jts.geom.util.AffineTransformation}
