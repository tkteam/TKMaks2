...
public class CoordinateArrays {
  ...
  /**
   * Compares two {@link com.vividsolutions.jts.geom.Coordinate} arrays
  ...
  /**
   * A {@link java.util.Comparator} for {@link com.vividsolutions.jts.geom.Coordinate} arrays
   * in the forward direction of their coordinates,
   * using lexicographic ordering.
   */
  ...
  /**
   * Determines which orientation of the {@link com.vividsolutions.jts.geom.Coordinate} array
   * is (overall) increasing.
   * In other words, determines which end of the array is "smaller"
   * (using the standard ordering on {@link com.vividsolutions.jts.geom.Coordinate}).
  ...
  /**
   * Determines whether two {@link com.vividsolutions.jts.geom.Coordinate} arrays of equal length
  ...
  /**
   * Creates a deep copy of the argument {@link com.vividsolutions.jts.geom.Coordinate) array.
   *
   ...
   * @see #hasRepeatedPoints(com.vividsolutions.jts.geom.Coordinate[])
   */
   ...
   * @see com.vividsolutions.jts.geom.Coordinate#equals(Object)
   */
  ...
  /**
   * Returns true if the two arrays are identical, both null, or pointwise
   * equal, using a user-defined {@link java.util.Comparator} for {@link com.vividsolutions.jts.geom.Coordinate} s
   *
   ...
   *@see com.vividsolutions.jts.geom.Coordinate#compareTo(Object)
   */
  ...
  /**
   * Extracts a subsequence of the input {@link com.vividsolutions.jts.geom.Coordinate} array
