    ...
    implements Serializable
{
  ...
  /**
   * Constructs a GeometryFactory that generates Geometries having the given
   * {@link com.vividsolutions.jts.geom.PrecisionModel} and the default CoordinateSequence
   * implementation.
   *
  ...
  /**
   * Constructs a GeometryFactory that generates Geometries having the given
   * {@link com.vividsolutions.jts.geom.PrecisionModel} and spatial-reference ID, and the default CoordinateSequence
   * implementation.
   *
   * @param precisionModel the PrecisionModel to use
  ...
  /**
   * Creates a {@link com.vividsolutions.jts.geom.MultiPoint} using the given {@link com.vividsolutions.jts.geom.Coordinate}s.
   * A null or empty array will create an empty MultiPoint.
   *
   * @param coordinates an array (without null elements), or an empty array, or <code>null</code>
   * @return a MultiPoint object
