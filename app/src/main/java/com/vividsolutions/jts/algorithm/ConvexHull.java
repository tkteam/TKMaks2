...
/**
 * Computes the convex hull of a {@link com.vividsolutions.jts.geom.Geometry}.
...
public class ConvexHull
{
  ...
  /**
   * Create a new convex hull construction for the input {@link com.vividsolutions.jts.geom.Coordinate} array.
   */
   ...
   * 2 points, a {@link com.vividsolutions.jts.geom.LineString};
   * 1 point, a {@link com.vividsolutions.jts.geom.Point};
   * 0 points, an empty {@link com.vividsolutions.jts.geom.GeometryCollection}.
   */
...
//          geometry.getPrecisionModel(), geometry.getSRID());
  ...
  /**
   * Compares {@link com.vividsolutions.jts.geom.Coordinate}s for their angle and distance
