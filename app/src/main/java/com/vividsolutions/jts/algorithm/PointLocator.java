...
/**
 * Computes the topological relationship ({@link com.vividsolutions.jts.geom.Location})
 * of a single point to a {@link com.vividsolutions.jts.geom.Geometry}.
 * The algorithm obeys the <i>SFS Boundary Determination Rule</i>
 * to determine whether the point lies on the boundary or not.
 * <p>
 * Notes:
 * <ul>
 * <li>{@link com.vividsolutions.jts.geom.LinearRing}s do not enclose any area - points inside the ring are still in the EXTERIOR of the ring.
 * </ul>
...
public class PointLocator
{
  ...
  /**
   * Computes the topological relationship ({@link com.vividsolutions.jts.geom.Location}) of a single point
   * to a Geometry.
   ...
   *
   * @return the {@link com.vividsolutions.jts.geom.Location} of the point relative to the input Geometry
   */
