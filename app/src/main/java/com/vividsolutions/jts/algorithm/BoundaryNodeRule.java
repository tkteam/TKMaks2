 ...
 * the {@link com.vividsolutions.jts.algorithm.BoundaryNodeRule.Mod2BoundaryNodeRule} rule.
 * However, other kinds of Boundary Node Rules are appropriate
 * in specific situations (for instance, linear network topology
 * usually follows the {@link com.vividsolutions.jts.algorithm.BoundaryNodeRule.EndPointBoundaryNodeRule}.)
...
public interface BoundaryNodeRule
{
  ...
  /**
   * A {@link com.vividsolutions.jts.algorithm.BoundaryNodeRule} specifies that points are in the
  ...
  /**
   * A {@link com.vividsolutions.jts.algorithm.BoundaryNodeRule} which specifies that any points which are endpoints
  ...
  /**
   * A {@link com.vividsolutions.jts.algorithm.BoundaryNodeRule} which determines that only
