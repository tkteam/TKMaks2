...
/**
 * Computes the minimum diameter of a {@link com.vividsolutions.jts.geom.Geometry}.
 ...
 *
 * @see com.vividsolutions.jts.algorithm.ConvexHull
 *
 * @version 1.7
 */
public class MinimumDiameter
{
  ...
  /**
   * Compute a minimum diameter for a giver {@link com.vividsolutions.jts.geom.Geometry}.
   *
  ...
  /**
   * Gets the {@link com.vividsolutions.jts.geom.Coordinate} forming one end of the minimum diameter
   *
  ...
  /**
   * Gets a {@link com.vividsolutions.jts.geom.LineString} which is a minimum diameter
   *
   * @return a {@link com.vividsolutions.jts.geom.LineString} which is a minimum diameter
   */
...
//System.out.println("Input = " + geom);
  ...
  /**
   * Compute the width information for a ring of {@link com.vividsolutions.jts.geom.Coordinate}s.
