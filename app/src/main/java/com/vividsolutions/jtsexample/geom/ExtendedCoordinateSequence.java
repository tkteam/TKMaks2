 ...
 * coordinate (an {@link com.vividsolutions.jtsexample.geom.ExtendedCoordinate} in this example). In this
    ...
    implements CoordinateSequence
{
   ...
   * with new {@link com.vividsolutions.jtsexample.geom.ExtendedCoordinate}s.
   *
